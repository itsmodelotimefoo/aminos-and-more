...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CpZEfKGL.js");
...
const manifest = {
  "3e225970265ca731cd1617a1ff3e08e3b988b9bd8e5797baff80e8296c6f3919": {
    ...
    importer: () => import("./orders.functions-vWbAxn6P.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C37s80Ou.js").then((n2) => n2.r),
    import("./start-Ca02J7xv.js"),
